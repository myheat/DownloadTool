	...
	OnClickListener oc = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.download1:
				...
				entry1.setPath(path);
				DownloadManager.getInstance(MainActivity.this).add(entry1);
				break;
			case R.id.pause1:
				DownloadManager.getInstance(MainActivity.this).pause(entry1);
				break;
			case R.id.resume1:
				DownloadManager.getInstance(MainActivity.this).resume(entry1);
				break;
			case R.id.download2:
				...
				DownloadManager.getInstance(MainActivity.this).add(entry2);
				break;
			case R.id.pause2:
				DownloadManager.getInstance(MainActivity.this).pause(entry2);
				break;
			case R.id.resume2:
				DownloadManager.getInstance(MainActivity.this).resume(entry2);
				break;
			}
		}
	};
